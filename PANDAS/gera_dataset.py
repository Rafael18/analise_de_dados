...
PRODUTOS = [
    ...
    {"nome": "Fone de Ouvido Sony", "id": 0, "preco": 600},
]
...
# Gerando dados a partir dos dados as compras
compras = []
...
for _ in range(2000):
    ...
    form_pagto = random.choice(FORMA_PAGTO)
