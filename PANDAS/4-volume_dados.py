...
valor_comras = f'R$ {valor_compras:.2f}'
col1.metric("Valor de compras no périodo", valor_compras)
col2.metric("Quantidade de compras no périodo", df_compras_filter['preco'].count())
...
col21.metric("Valor de compras no périodo", valor_compras_loja)
col22.metric("Quantidade de compras no périodo", quantidade_compras_loja)
...
valor_cimissao_vendedor = df_compras_filter[df_compras_filter["vendedor"] == principal_vendedor]["comissao"].sum()
valor_cimissao_vendedor = f'R$ {valor_cimissao_vendedor:.2f}'

col31, col32 = st.columns(2)

col31.metric("Valor de compras no périodo", valor_compras_vendedor)
col32.metric("Comissão no périodo", valor_cimissao_vendedor)